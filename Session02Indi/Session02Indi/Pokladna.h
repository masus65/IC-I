...
public:
	Pokladna();
	~Pokladna();
	Uctenka& vystavUctenku(double castka, double dph); // vystaví úètenku, nastaví parametry úètence v poli, inkrementuje pocetVydanychUctenek a vrací referenci na vystavenou úètenku.
	Uctenka& dejUctenku(int); // vyhledá a vrátí úètenku z pole dle cislaUctenky.Pokud neexistuje vrate první úètenku z pole.
